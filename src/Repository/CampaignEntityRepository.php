 ...
 */
class CampaignEntityRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, CampaignEntity::class);
    }
    ...
    // /**
    //  * @return CampaignEntity[] Returns an array of CampaignEntity objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?CampaignEntity
    {
        return $this->createQueryBuilder('c')
            ->andWhere('c.exampleField = :val')
            ->setParameter('val', $value)
